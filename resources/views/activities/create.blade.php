...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <div class="material-card" style="padding: 24px; cursor: default;">
        <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div>
                <h2 class="material-typography-h1" style="font-size: 28px; margin-bottom: 8px;">Tạo hoạt động mới</h2>
                <p class="material-typography-body1" style="color: #616161; margin: 0;">Điền thông tin để tạo hoạt động ngoại khóa mới</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('activities.store') }}" method="POST">
            ...
            <div style="background: linear-gradient(135deg, #4caf50 0%, #45a049 100%); color: white; padding: 24px 32px;">
                <h3 class="material-typography-h2" style="color: white; margin: 0 0 8px 0; display: flex; align-items: center; gap: 12px;">
                    <span class="material-icons" style="font-size: 28px;">add_circle</span>
                    Thông tin cơ bản
                </h3>
                <p class="material-typography-body1" style="color: rgba(255,255,255,0.9); margin: 0;">Nhập các thông tin cần thiết cho hoạt động</p>
            </div>
            ...
            <div style="padding: 32px; display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="material-form-field">
                    ...
                    <textarea name="content" 
                              ...
                              class="material-form-textarea @error('content') material-form-input-error @enderror">{{ old('content') }}</textarea>
                    @error('content')
                        <div class="material-form-error">
                            <span class="material-icons" style="font-size: 16px;">error</span>
                            {{ $message }}
                ...
                <div class="material-form-field">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                        <label class="material-radio-card @error('type') material-form-input-error @enderror">
                            <input type="radio" name="type" value="1" {{ old('type') == '1' ? 'checked' : '' }} class="material-radio-input">
                        ...
                        <label class="material-radio-card @error('type') material-form-input-error @enderror">
                            <input type="radio" name="type" value="2" {{ old('type') == '2' ? 'checked' : '' }} class="material-radio-input">
                            <div class="material-radio-content">
                                <div class="material-radio-indicator">
                                    <div class="material-radio-dot"></div>
                                </div>
                        ...
                        <label class="material-radio-card @error('type') material-form-input-error @enderror">
                            <input type="radio" name="type" value="3" {{ old('type') == '3' ? 'checked' : '' }} class="material-radio-input">
                            <div class="material-radio-content">
                                <div class="material-radio-indicator">
                                    <div class="material-radio-dot"></div>
                                </div>
...
document.querySelectorAll('.material-radio-input').forEach(radio => {
    radio.addEventListener('change', function() {
        ...
        document.querySelectorAll('.material-radio-card').forEach(card => {
