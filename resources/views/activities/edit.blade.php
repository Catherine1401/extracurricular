    ...
    @enderror
                    ...
                    <div class="material-form-field">
                        ...
                        <select name="category" 
                            ...
                            <option value="academy" {{ old('category', $activity->category) == 'academy' ? 'selected' : '' }}>Học thuật</option>
                            <option value="sport" {{ old('category', $activity->category) == 'sport' ? 'selected' : '' }}>Thể thao</option>
                            <option value="volunteer" {{ old('category', $activity->category) == 'volunteer' ? 'selected' : '' }}>Tình nguyện</option>
                        </select>
                        @error('category')
                            <div class="material-form-error">
                                <span class="material-icons" style="font-size: 16px;">error</span>
